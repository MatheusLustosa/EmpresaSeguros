...
import cesar.next.desafio.spring.demo.services.ClientService;
...
public class ClientController {
    ...
    @DeleteMapping("/{id}")// O ponto de interrogação (?) indica que o corpo da resposta pode ser de qualquer tipo.
